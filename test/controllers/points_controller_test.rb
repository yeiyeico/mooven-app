...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { address: @point.address, latitude: @point.latitude, longitude: @point.longitude, name: @point.name }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { address: @point.address, latitude: @point.latitude, longitude: @point.longitude, name: @point.name }
    assert_redirected_to point_path(assigns(:point))
  end
